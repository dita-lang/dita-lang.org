...
The following example demonstrates the use of definition description in an XDITA topic.
...
The following example demonstrates the use of definition description text in an HDITA topic.
